...
let upgrade = ["create table discovery_storage(\
...
"create index discovery_storage_contract_index on discovery_storage(contract)" ;
...
"create table discovery__default(\
contract varchar not null, \
transaction varchar not null, \
block varchar not null, \
index int not null, \
...
"create index discovery__default_contract_index on discovery__default(contract)" ;
...
tsp timestamp not null, \
main boolean not null, \
key__parameter jsonb not null, \
value__parameter jsonb not null)" ;
