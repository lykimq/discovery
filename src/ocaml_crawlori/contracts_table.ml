let downgrade = ["drop contracts cascade"]

let upgrade =
  [
    "create table contracts(address varchar not null, kind varchar not null, \
     ...
     bmid_discovery_ zarith, bmid_consensus_vault_vault zarith, \
